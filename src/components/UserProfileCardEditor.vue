    ...
    <div class="profile-card">
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.username.$error">
          <!-- <span v-if="!$v.activeUser.username.required"
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.name.$error">
          <!-- <span v-if="!$v.activeUser.name.required"
          class="form-error">The name field is required</span>-->
        </template>
      </div>
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.email.$error">
          <!-- <span v-if="!$v.activeUser.email.required"
          class="form-error">This field is required</span>-->
          <!-- <span
